...
keras.preprocessing.image.save_img("8-Visualizing_CNN_Learnings/0.png", img)
...
display(Image("8-Visualizing_CNN_Learnings/0.png"))
...
keras.preprocessing.image.save_img(
    "8-Visualizing_CNN_Learnings/stiched_filters.png", stitched_filters)


display(Image("8-Visualizing_CNN_Learnings/stiched_filters.png"))
